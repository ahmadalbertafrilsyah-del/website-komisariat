...
export default function AlumniPage() {
  ...
  const ITEMS_PER_PAGE = 15; // Jumlah kartu alumni per halaman
  ...
  // Mereset kembali ke halaman 1 setiap kali user mengetik sesuatu di kolom pencarian
  useEffect(() => {
    setCurrentPage(1);
  }, [searchQuery]);

  // Pencarian mencakup bidang dan deskripsi profesi
  ...
  // LOGIKA PAGINATION (Pembagian Halaman)
  ...
  // Fungsi untuk membuat deret angka pagination dengan format "1 2 3 ... 10"
  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] font-sans text-slate-800 flex flex-col relative">
          ...
          <>
            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center gap-2 md:gap-3 mt-12 md:mt-16 w-full">
                ...
                {/* Nomor Halaman: Muncul di Tablet & Laptop */}
                ...
                {/* Indikator Halaman Sederhana: Hanya Muncul di HP */}
      ...
      {/* MODAL POP-UP DETAIL ALUMNI TETAP SAMA */}
      <AnimatePresence>
        {selectedAlumni && (

...
export default function DetailRayonPage() {
  ...
  const PersonilCard = ({ jabatan, nama, wa, icon }) => (
    <div className="bg-slate-50 border border-slate-100 p-4 rounded-2xl flex items-center justify-between gap-3 hover:border-blue-200 transition-colors">
  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] font-sans text-slate-800 w-full overflow-x-hidden flex flex-col">
      ...
      {/* ================= 2. INFORMASI STRATEGIS & PENGURUS INTI ================= */}
      <section className="px-5 max-w-7xl mx-auto w-full -mt-16 md:-mt-20 relative z-20 mb-12">
        <div className="bg-white rounded-[2rem] p-6 md:p-8 shadow-xl border border-slate-100">
          ...
          {/* Top Section: Basecamp & Sosmed */}
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 justify-between items-start lg:items-center pb-6 md:pb-8 border-b border-slate-100">

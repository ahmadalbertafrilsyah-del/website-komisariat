  ...
  return (
    <div className="space-y-6 pb-12 w-full max-w-6xl mx-auto">
      ...
      <div className="grid lg:grid-cols-3 gap-6 items-start">
        ...
        {/* ================= 1. KOTAK KONFIGURASI WEB UTAMA ================= */}
        <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden lg:col-span-1">
          ...
          <form onSubmit={handleSaveConfig} className="p-5 space-y-4">
            <div>
              <label className="text-xs font-bold text-slate-700 block mb-1">Tautan Web Berita (Cth: Wordpress)</label>
              <input 
                type="url" 
                value={externalLink}
                onChange={(e) => setExternalLink(e.target.value)}
                className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-xs font-mono"
            ...
            <button type="submit" className="w-full bg-slate-900 hover:bg-blue-600 text-white font-bold py-2.5 rounded-xl transition flex items-center justify-center gap-2 shadow-sm text-xs">
              Simpan Tautan <Save size={14} />
            </button>
          </form>
        </div>

        {/* ================= 2. EDITOR ARTIKEL PROFESIONAL ================= */}
        <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden lg:col-span-2">
          ...
          <form onSubmit={handleSaveArticle} className="p-5 md:p-6 space-y-5">
            ...
            <div className="grid md:grid-cols-2 gap-4">
               ...
               {/* MODIFIKASI: Tombol Upload Gambar Cloudinary */}
               <div>
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-2">
                    ...
                    {/* Input Teks Hasil URL (Bisa Diedit Manual) */}
                    <input 
            ...
            <div>
              ...
              <style jsx global>{`
                ...
                .ql-container { border: none !important; min-height: 250px; font-size: 15px; font-family: inherit; }
                .ql-editor { min-height: 250px; }
              `}</style>
            </div>

            <div className="flex justify-end pt-2">
               <button type="submit" disabled={isUploading} className="bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-bold py-3 px-8 rounded-xl transition flex items-center justify-center gap-2 shadow-md">
            ...
            <table className="w-full text-left border-collapse whitespace-nowrap min-w-[800px]">
              <thead className="bg-[#1e293b] text-white">
                <tr>
                  ...
                  <th className="py-3 px-4 text-xs font-bold uppercase tracking-wider">Judul Artikel</th>
                  <th className="py-3 px-4 text-xs font-bold uppercase tracking-wider w-40">Kategori</th>
                  <th className="py-3 px-4 text-xs font-bold uppercase tracking-wider w-32">Tanggal</th>
                    ...
                    <tr key={item.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-3">
                           ...
                           <span className="font-bold text-slate-800 truncate max-w-[300px]">{item.title}</span>
                        </div>
                      </td>

    ...
    <div className="flex h-screen w-full bg-slate-50 overflow-hidden font-sans text-slate-800">
      ...
      >
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto hide-scrollbar">
          ...
          <Link href="/admin/pendaftaran" onClick={() => setSidebarOpen(false)} className={menuStyle("/admin/pendaftaran")}>
            <Newspaper size={18} className={pathname === "/admin/pendaftaran" ? "text-blue-400" : ""} /> Pendaftaran
          </Link>
